...
namespace GaCloudServer.Resources.Api.Dtos.Garbage
{


    public class GarbageUtenzaApiDto
    {
    ...
    public class GarbagePartitaApiDto
    {
    ...
    public class GarbageTipologiaApiDto
    {
    ...
    public class GarbageProvenienzaApiDto
    { 
        public long Id { get; set; }
        public string Descrizione { get; set; }
    }

    public class GarbageStatoApiDto
    {
        public long Id { get; set; }
        public string Descrizione { get; set; }
    }

    public class GarbageTicketContactCenterApiDto
    {
        public long Id { get; set; }
    ...
    public class GarbageTicketMagazzinoApiDto
    {
        public long Id { get; set; }
        public DateTime DATA_RICHIESTA { get; set; }
        public DateTime? DATA_CHIUSURA { get; set; }
