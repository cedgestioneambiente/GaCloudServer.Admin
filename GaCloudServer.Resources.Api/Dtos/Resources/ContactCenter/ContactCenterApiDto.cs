...
namespace GaCloudServer.Resources.Api.Dtos.Resources.ContactCenter
{
    ...
    public class ContactCenterPrintTemplateApiDto : GenericListApiDto
    {
        public string? Template { get; set; }
    }

    public class ContactCenterPrintTemplatesApiDto : GenericPagedListApiDto<ContactCenterPrintTemplateApiDto>
    {
    }
