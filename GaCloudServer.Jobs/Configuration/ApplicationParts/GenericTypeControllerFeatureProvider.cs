...
namespace GaCloudServer.Jobs.Configuration.ApplicationParts
{
    public class GenericTypeControllerFeatureProvider<
        TProvaDto,TProveDto> : IApplicationFeatureProvider<ControllerFeature>

        where TProvaDto:class
        where TProveDto:class
    {
        public void PopulateFeature(IEnumerable<ApplicationPart> parts, ControllerFeature feature)
        {
            var currentAssembly = typeof(GenericTypeControllerFeatureProvider<
                TProvaDto,TProveDto>).Assembly;
