...
namespace GaCloudServer.BusinnessLogic.Services
{
    public class GaPersonaleService : IGaPersonaleService
    {
        ...
        {
            var view = all == true ? await viewGaPersonaleUsersOnDipendentiRepo.GetAllAsync(1, 0, "CognomeNome") : await viewGaPersonaleUsersOnDipendentiRepo.GetWithFilterAsync(x => x.ShowInApp != all, 1, 0, "CognomeNome");
            return view;
        }
