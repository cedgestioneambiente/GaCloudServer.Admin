...
namespace GaCloudServer.BusinessLogic.Mappers.Personale
{
    internal class PersonaleMapperProfile : Profile
    {
        public PersonaleMapperProfile()
        {
            ...
            //PersonaleScadenze
            CreateMap<PersonaleScadenza, PersonaleScadenzaDto>(MemberList.Destination)
                .ReverseMap();

            CreateMap<PagedList<PersonaleScadenza>, PersonaleScadenzeDto>(MemberList.Destination)
                .ReverseMap();
