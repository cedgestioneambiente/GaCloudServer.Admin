...
{
    public partial class GaPreventiviAnticipi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPreventivo = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DataPagamento = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CfPiva = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValorePrevisto = table.Column<double>(type: "float", nullable: false),
                    ValoreIncassato = table.Column<double>(type: "float", nullable: true),
