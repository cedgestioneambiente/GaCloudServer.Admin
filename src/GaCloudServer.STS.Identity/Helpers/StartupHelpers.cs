...
using GaCloudServer.STS.Identity.Configuration;
using GaCloudServer.STS.Identity.Configuration.ApplicationParts;
using GaCloudServer.STS.Identity.Configuration.Constants;
using GaCloudServer.STS.Identity.Configuration.Interfaces;
using GaCloudServer.STS.Identity.Helpers.Localization;

namespace GaCloudServer.STS.Identity.Helpers
{
