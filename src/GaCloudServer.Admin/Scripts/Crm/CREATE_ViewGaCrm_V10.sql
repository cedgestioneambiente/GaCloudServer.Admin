...
/****** Object:  View [dbo].[ViewGaCrmCommercialeTickets]    Script Date: 07/05/2024 15:45:32 ******/
SET ANSI_NULLS ON
GO
...
DROP VIEW IF EXISTS [dbo].[ViewGaCrmCommercialeTickets]
GO

CREATE VIEW [dbo].[ViewGaCrmCommercialeTickets]
AS
SELECT A.Id,A.Id Numero,DataTicket,A.DataRichiesta,
B.Id ComuneId,B.CodAzi ComuneCod,
CASE WHEN (B.CodAzi='C00') OR (B.CodAzi='C90') THEN A.ComuneAlt ELSE B.Descrizione END ComuneDesc,
B.Duration,
