...
DROP VIEW IF EXISTS [dbo].[ViewGaPreventiviCrmTickets]
GO

CREATE VIEW [dbo].[ViewGaPreventiviCrmTickets]
AS
SELECT 
A.Id
,A.DataTicket
,A.DataRichiesta
,B.CodAzi ComuneCod
,CASE WHEN (B.CodAzi='C00') OR (B.CodAzi='C90') THEN A.ComuneAlt ELSE B.Descrizione END ClienteComune
,A.CodCli CodCliente
,A.Utente Cliente
