...
namespace GaCloudServer.Admin.EntityFramework.Shared.DbContexts.Interfaces
{
    public interface IResourcesDbContext
    {
        ...
        DbSet<PrevisioAnomaliaLettura> GaPrevisioAnomalieLetture { get; set; }
        ...
        DbSet<ProgettiJobUndertaking> GaProgettiJobsUndertakings { get; set; }
        DbSet<ProgettiJobUndertakingState> GaProgettiJobsUndertakingsStates { get; set; }
        DbSet<ProgettiJobUndertakingAllegato> GaProgettiJobsUndertakingsAllegati { get; set; }
        ...
        DbSet<CrmTicketAzione> GaCrmTicketAzioni { get; set; }
        ...
        DbSet<PreventiviIsmartDocumento> GaPreventiviIsmartDocumenti { get; set; }
