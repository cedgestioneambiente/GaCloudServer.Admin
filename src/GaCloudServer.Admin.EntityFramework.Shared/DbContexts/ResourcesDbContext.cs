...
namespace GaCloudServer.Admin.EntityFramework.Shared.DbContexts
{
    public class ResourcesDbContext : DbContext, IResourcesDbContext
    {
        ...
        public DbSet<ConsorzioComuneDemografia> ConsorzioComuniDemografie { get; set; }
        ...
        public DbSet<ViewConsorzioComuniDemografie> ViewConsorzioComuniDemografie { get; set; }
        #endregion
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ViewGaBackOfficeUtenzeZone>(entity =>
            {
                entity
                .ToView(nameof(ViewGaBackOfficeUtenzeZone))
                .HasNoKey();
            });
            ...
            builder.Entity<ViewConsorzioComuniDemografie>(entity =>
            {
                entity
                .ToView(nameof(ViewConsorzioComuniDemografie))
                .HasKey(x => x.Id);
            });
