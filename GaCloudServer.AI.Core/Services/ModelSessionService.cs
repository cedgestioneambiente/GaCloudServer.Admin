using GaCloudServer.AI.Core.Async;
using GaCloudServer.AI.Core.Config;
...
namespace GaCloudServer.AI.Core.Services
{
    /// <summary>
    /// Service for handling model sessions
    /// </summary>
    /// <typeparam name="T">Type used for the session identifier</typeparam>
    /// <seealso cref="GaCloudServer.AI.Core.Services.IModelSessionService&lt;T&gt;" />
    public class ModelSessionService<T> : IModelSessionService<T> where T : IEquatable<T>, IComparable<T>
    {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Streaming async result of <see cref="GaCloudServer.AI.Core.Models.InferTokenModel" /></returns>
