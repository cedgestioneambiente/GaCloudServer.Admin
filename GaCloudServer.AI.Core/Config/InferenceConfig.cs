using GaCloudServer.AI.Core.Common;
using GaCloudServer.AI.Core.Models;

namespace GaCloudServer.AI.Core.Config
{
    /// <summary>
    /// Concrete implemtation of IInferenceConfig
    /// </summary>
    /// <seealso cref="GaCloudServer.AI.Core.Config.IInferenceConfig" />
    public class InferenceConfig : IInferenceConfig
    {
        ...
        /// <summary>
        /// Gets or sets a list of <see cref="GaCloudServer.AI.Core.Models.LogitBiasModel" /> objects that provide bias information for specific tokens in the language model's vocabulary
        /// </summary>
